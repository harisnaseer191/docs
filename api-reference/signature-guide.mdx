...
<AccordionGroup>
  ...
  <Accordion title="Objects & Arrays: Completely excluded">
    Complex nested objects are NOT included in signature calculation.
    Arrays of any type are NOT included in signature calculation.
  </Accordion>
