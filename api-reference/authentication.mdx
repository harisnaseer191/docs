...
const response = await fetch(
  'https://waypay-merchant-api.icydesert-41d42f7e.uaenorth.azurecontainerapps.io/Gateway/v1/Transaction/by-ref/TXN123456',
  {
    method: 'GET',
    headers: {
      'Authorization': `Bearer ${process.env.WAYPAY_API_KEY}`
    }
  }
);
...
2. Ensure the header format is exactly: `Authorization: Bearer YOUR_API_KEY`
...
While the `Authorization` header is required, you may also include optional headers:
