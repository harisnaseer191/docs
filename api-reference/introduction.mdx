---
title: 'Introduction'
description: 'Swich Gateway API overview and usage guide'
---

<Note>
  This section documents the Swich Gateway API using the bundled OpenAPI spec.
</Note>

## Overview

The Swich Gateway lets merchants:
