...
|-------------|----------|----------------|
| Test | `https://waypay-merchant-api.icydesert-41d42f7e.uaenorth.azurecontainerapps.io/Gateway/v1` | `pk_test_` |
| Production | `https://waypay-merchant-api.icydesert-41d42f7e.uaenorth.azurecontainerapps.io/Gateway/v1` | `pk_live_` |
