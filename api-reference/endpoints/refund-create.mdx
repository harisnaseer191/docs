...
```bash cURL
curl --request POST \
  --url https://waypay-merchant-api.icydesert-41d42f7e.uaenorth.azurecontainerapps.io/Gateway/v1/Refunds \
...
```javascript Node.js
const response = await fetch('https://waypay-merchant-api.icydesert-41d42f7e.uaenorth.azurecontainerapps.io/Gateway/v1/Refunds', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://waypay-merchant-api.icydesert-41d42f7e.uaenorth.azurecontainerapps.io/Gateway/v1/Refunds',
    headers={
        'SWICH-API-Key': 'sk_test_xxxxxxxx',
        'Content-Type': 'application/json'
    },
