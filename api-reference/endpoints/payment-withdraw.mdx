...
<ParamField body="callbackUrl" type="string">
  Dynamic callback URL for redirecting customers after payout completion
  
  This URL will be used to redirect the customer after the withdrawal/payout is processed. You can include query parameters or path segments that will be preserved. The payout status and details will be appended as query parameters.
  
  **Maximum length:** 2048 characters
  
  **Example:** `https://yoursite.com/withdrawal/callback?request_id=xyz789`
</ParamField>
